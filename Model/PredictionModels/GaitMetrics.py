...
class GaitMetrics:
    ...
    def parse_landmarks(self, required_landmarks: List[int]) -> List[Landmark]:
        metric_landmarks = []
    ...
    # TODO: Change the metric names to what we have
    ...
    def metric1(self, required_landmarks: List[int]):
        ...
        metric_landmarks = self.parse_landmarks(required_landmarks)
